"""ACP agent server — exposes Icarus via the Agent Client Protocol."""
...
from icarus_branding import ACP_IMPLEMENTATION_NAME, PRODUCT_NAME
...
class HermesACPAgent(acp.Agent):
    ...
    async def initialize(
        ...
        **kwargs: Any,
        ...
        if provider:
            auth_methods = [
                AuthMethodAgent(
                    ...
                    description=f"Authenticate {PRODUCT_NAME} using the currently configured {provider} runtime credentials.",
                )
            ]
        ...
        return InitializeResponse(
            ...
            agent_info=Implementation(name=ACP_IMPLEMENTATION_NAME, version=HERMES_VERSION),
    ...
    def _cmd_version(self, args: str, state: SessionState) -> str:
        return f"{PRODUCT_NAME} Agent v{HERMES_VERSION}"
