...
# Load .env from the runtime home (Icarus-first) first, then project root as dev fallback.
...
class _SafeWriter:
    ...
    When Icarus runs as a systemd service, Docker container, or headless
...
class AIAgent:
    ...
    def __init__(
        ...
        if _ctx and _ctx < MINIMUM_CONTEXT_LENGTH:
            raise ValueError(
                ...
                f"by Icarus Agent.  Choose a model with at least "
    ...
    def _build_api_kwargs(self, api_messages: list) -> dict:
        ...
        if _is_nous:
            extra_body["tags"] = ["product=icarus-agent"]
    ...
    def _handle_max_iterations(self, messages: list, api_call_count: int) -> str:
        ...
        try:
            ...
            if _is_nous:
                summary_extra_body["tags"] = ["product=icarus-agent"]
