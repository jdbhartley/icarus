---
sidebar_position: 6
title: "Use MCP with Icarus"
description: "A practical guide to connecting MCP servers to Icarus, filtering their tools, and using them safely in real workflows"
---

# Use MCP with Icarus

This guide shows how to actually use MCP with Icarus in day-to-day workflows.
