...
sidebar_position: 3
title: "Discord"
description: "Set up Icarus as a Discord bot"
---

# Discord Setup

Icarus integrates with Discord as a bot, letting you chat with your AI assistant through direct messages or server channels. The bot receives your messages, processes them through the Icarus pipeline (including tool use, memory, and reasoning), and responds in real time. It supports text, voice messages, file attachments, and slash commands.
...
3. Enter a name for your application (e.g., "Icarus") and accept the Developer Terms of Service.
4. Click **Create**.
...
The bot token is the credential Icarus uses to log in as your bot. Still on the **Bot** page:
...
Icarus uses your Discord User ID to control who can interact with the bot. To find it:
...
Icarus supports Discord voice messages:
...
- [Use Voice Mode with Icarus](/docs/guides/use-voice-mode-with-hermes)
...
For more information on securing your Icarus deployment, see the [Security Guide](../security.md).
