...
description: "Use Icarus inside ACP-compatible editors such as VS Code, Zed, and JetBrains"
---

# ACP Editor Integration

Icarus can run as an ACP server, letting ACP-compatible editors talk to Hermes over stdio and render:
