...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Icarus — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Icarus! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
```bash
git clone --recurse-submodules https://github.com/jdbhartley/icarus.git
cd hermes-agent
...
- **Profile-safe paths**: Never hardcode `~/.hermes` — use `get_hermes_home()` from `hermes_constants` for code paths and `display_hermes_home()` for user-facing messages. See [AGENTS.md](https://github.com/jdbhartley/icarus/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- Use [GitHub Issues](https://github.com/jdbhartley/icarus/issues)
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/jdbhartley/icarus/blob/main/LICENSE).
