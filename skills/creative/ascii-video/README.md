...
Built for [Icarus](https://github.com/jdbhartley/icarus). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/hermes-agent/skills/creative/ascii-video`](https://github.com/jdbhartley/icarus/tree/main/skills/creative/ascii-video) via PR.
