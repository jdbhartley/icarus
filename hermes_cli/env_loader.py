"""Helpers for loading Icarus/Hermes .env files consistently across entrypoints."""
...
def load_hermes_dotenv(
    *,
    ...
    """Load runtime environment files with user config taking precedence.

    Behavior:
    - `ICARUS_HOME/.env` overrides stale shell-exported values when present.
