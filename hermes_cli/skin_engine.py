...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Icarus"          # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Icarus"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "Icarus",
            "welcome": "Welcome to Icarus! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
